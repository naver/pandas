######
# Modified version of: https://github.com/ContinualAI/avalanche/blob/master/examples/tvdetection/lvis_eval.py
######
...
from lvis import LVISResults, LVIS
from .lvis_eval_with_float import LVISEval
...
class LvisEvaluator:
    ...
    def accumulate(self, max_dets_per_image=None):  # old name: evaluate
